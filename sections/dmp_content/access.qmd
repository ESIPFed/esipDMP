...
See [DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}: [`distribution`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#distribution_table){target="_blank"} 
...
See [DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}: [`preservation_statement`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dataset_preservation){target="_blank"} 
...
-  Consider using repository persistent identifiers (PIDs) to identify where data will be stored or deposited
    -  Repository PIDs can be found at [Re3data](https://www.re3data.org){target="_blank"}
...
See [DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}: [`available_until`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#distribution_available_until){target="_blank"}
...
See [DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}: [`license`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#license_table){target="_blank"}
...
See [DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}: [`data_access`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#distribution_data_access){target="_blank"}, [`personal_data`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dataset_personal_data){target="_blank"}, & [`sensitive_data`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dataset_sensitive_data){target="_blank"}
...
::::
::::{.commentbox-body}
**These authors use descriptive language but do not explicitly declare a license.  Data reuse terms would be clearer if the authors stated a license (e.g. [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/){target="_blank"}).**
::::
:::
