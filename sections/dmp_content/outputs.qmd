...
See [DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}: [`dataset`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dataset_table){target="_blank"}
...
See [DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}: [`byte_size`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#distribution_byte_size){target="_blank"}
...
See [DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}: [`metadata`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#metadata_table){target="_blank"}
...
See [DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}: [`dataset_id`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dataset_id_table){target="_blank"}
