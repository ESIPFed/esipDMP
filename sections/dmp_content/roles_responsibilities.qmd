...
::: {.callout-tip}
## Relevant literature
Wood-Charlson EM, Crockett Z, Erdmann C, Arkin AP, Robinson CB (2022) **Ten simple rules for getting and giving credit for data**. PLOS Computational Biology 18(9): e1010476. <https://doi.org/10.1371/journal.pcbi.1010476>{target="_blank"}
:::
...
See [DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}: [`contributor`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_contributor_table){target="_blank"}

-   Consider using persistent identifiers (PIDs), such as [ORCiD](https://orcid.org){target="_blank"}, to identify and disambiguate personnel
...
See [DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}: [`contact`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_contact_table){target="_blank"}
...
See [DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}: [`contact_id`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#contact_id_table){target="_blank"} & [`contributor_id`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#contributor_id_table){target="_blank"}

-  Persistent identifiers (PIDs) help identify the support for the research  
    -   [RAID](https://raid.org){target="_blank"} - a project meta-PID  
    -   [RRID](https://www.rrids.org){target="_blank"}  
    -   [DataCite (DOIs)](https://datacite.org){target="_blank"}  
