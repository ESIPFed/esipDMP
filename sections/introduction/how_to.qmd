...
One feature being developed by the [RDA DMP Common Standards Working Group](https://www.rd-alliance.org/groups/dmp-common-standards-wg/members/all-members/) is the [RDA DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table). These are sprinkled throughout this resource as links to the RDA site, which is curating a standardized vocabulary to represent DMPs[^1].
