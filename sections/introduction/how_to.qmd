...
One feature being developed by the [RDA DMP Common Standards Working Group](https://www.rd-alliance.org/groups/dmp-common-standards-wg/members/all-members/){target="_blank"} is the [RDA DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}. These are sprinkled throughout this resource as links to the RDA site, which is curating a standardized vocabulary to represent DMPs[^1].
...
::::
::::{.commentbox-body}
e.g., See [`dataset_id`](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dataset_id_tree){target="_blank"} in [RDA DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#dmp_table){target="_blank"}, this should take you to the Common Standard definition for a “properties in ‘dataset’”. 
