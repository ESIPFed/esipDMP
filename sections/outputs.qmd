...
-   **Samples**
    -   Physical samples (e.g., biological, chemical, geological)
        -   e.g.:
            -   [Mullineaux #2453](https://drive.google.com/file/d/1-N-bHKeJbC1QTouZVT5Ae2MMSAG9CEYA/view?usp=share_link) - Physical samples will include animals, rocks, and water column samples. Rocks and animal specimens for which we extract gut contents will be assigned unique sample identifiers, important for provenance for subsamples to be analyzed for microbes.
...
-   BCO-DMO: [Alexander](https://drive.google.com/file/d/1xdAynJgxfdbvASA60xuP4oKib8gxm5Nv/view?usp=share_link)
...
-   **Size of each file, sample, etc.**
    ...
    -   Physical dimensions or quantities for physical samples.
        -   e.g.:
            -   [Sosik](https://drive.google.com/file/d/1-kTwz8I46snB0tfNk4U8bk8suVjF8xjG/view?usp=drive_link) LTER
